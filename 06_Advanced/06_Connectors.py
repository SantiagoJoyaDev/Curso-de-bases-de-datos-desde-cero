# CONNECTORS
"""Un conector es un componente o librería que permite que una aplicación se comunique con una base de datos.
Su función principal es establecer la conexión, enviar consultas SQL y recibir los resultados."""
...
print_user("Santiago")
#print_user("'; UPDATE users SET age = '15' WHERE user_id = 10; --")